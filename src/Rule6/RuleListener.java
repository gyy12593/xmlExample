...
public interface RuleListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link RuleParser#integerScope}.
	 * @param ctx the parse tree
	 */
	void enterIntegerScope(RuleParser.IntegerScopeContext ctx);
	/**
	 * Exit a parse tree produced by {@link RuleParser#integerScope}.
	 * @param ctx the parse tree
	 */
	void exitIntegerScope(RuleParser.IntegerScopeContext ctx);
	/**
	 * Enter a parse tree produced by {@link RuleParser#character4Start}.
	 * @param ctx the parse tree
	 */
	void enterCharacter4Start(RuleParser.Character4StartContext ctx);
	/**
	 * Exit a parse tree produced by {@link RuleParser#character4Start}.
	 * @param ctx the parse tree
	 */
	void exitCharacter4Start(RuleParser.Character4StartContext ctx);
	/**
	 * Enter a parse tree produced by {@link RuleParser#character4End}.
	 * @param ctx the parse tree
	 */
	void enterCharacter4End(RuleParser.Character4EndContext ctx);
	/**
	 * Exit a parse tree produced by {@link RuleParser#character4End}.
	 * @param ctx the parse tree
	 */
	void exitCharacter4End(RuleParser.Character4EndContext ctx);
	/**
	 * Enter a parse tree produced by {@link RuleParser#startNumber}.
	 * @param ctx the parse tree
	 */
	void enterStartNumber(RuleParser.StartNumberContext ctx);
	/**
	 * Exit a parse tree produced by {@link RuleParser#startNumber}.
	 * @param ctx the parse tree
	 */
	void exitStartNumber(RuleParser.StartNumberContext ctx);
	/**
	 * Enter a parse tree produced by {@link RuleParser#endNumber}.
	 * @param ctx the parse tree
	 */
	void enterEndNumber(RuleParser.EndNumberContext ctx);
	/**
	 * Exit a parse tree produced by {@link RuleParser#endNumber}.
	 * @param ctx the parse tree
	 */
	void exitEndNumber(RuleParser.EndNumberContext ctx);
	/**
