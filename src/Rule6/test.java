...
public class test {
	public static void main(String arg[]) throws Exception {
		String in="StudentT$age$LIST 12 INTEGER [1700,2300]$"; //测试通过 
		//String in="StudentT$sex$LIST 3 sex(woman,man)$";//测试通过
		//String in="StudentT$sex$LIST 4 sex(woman,man)$";//测试通过
		//String in="StudentT$studentNo$String$LIST 5fre_f[[0-9]^10]$";//测试通过
		//String in="StudentT$startTime$Date$LIST 4 DATE$";//测试通过
		//String in="StudentT$color$LIST 14 ENUM CYCLE$";//测试通过
		//String in="TeacherT$classList$ ASSOCIATION$";//测试通过
