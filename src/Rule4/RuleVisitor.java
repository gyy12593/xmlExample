...
public interface RuleVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link RuleParser#typeNames}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTypeNames(RuleParser.TypeNamesContext ctx);
	/**
	 ...
	 * labeled alternative in {@link RuleParser#express4Dataexpress4Dataexpress4Dataexpress4Dataexpress4Dataexpress4Dataexpress4Data}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
