...
//////////////////////////////////////////////////////////日期处理开始////////////////////////////////////////////
	...
	/** attAndTypeName?  DATE Style4generate? SEPARATOR            # printDate   //现在实现的时间是1990年1月1日到现在时间的选取*/
	@Override
...
//////////////////////////////////////////////////////////枚举处理开始////////////////////////////////////////////
	/** attAndTypeName?  ENUM	Style4generate?  SEPARATOR          # printEnum  	 //枚举 */
	@Override
...
//////////////////////////////////////////////////////////Ip处理开始////////////////////////////////////////////
	/**  attAndTypeName?  ip Style4generate?	SEPARATOR          # printIP            //一定范围内的ip */
	...
	/** ip : 'IP' range4Ip+    #process4Ip;*/
	@Override 
	public ArrayList<String> visitProcess4Ip(RuleParser.Process4IpContext ctx) { 
...
//////////////////////////////////////////////////////////ID处理开始////////////////////////////////////////////
    /**  attAndTypeName?  id Style4generate?   SEPARATOR             # printId    */
	@Override
	...
	@Override
	public ArrayList<String> visitChooseDigit(RuleParser.ChooseDigitContext ctx) {
	...
	*/
	@Override
	public ArrayList<String> visitProcess4Id1(RuleParser.Process4Id1Context ctx) {
		System.out.println("进入visitProcess 1 ");
		String temp1="";
		...
		for(int ii=0;ii<num4IdList;ii++){
			...
			String temp2="";
			for(int i=0;i<tt;i++)
				temp2=temp2+visit(ctx.chooseD()).get(0);
	...
	*/
	@Override
	public ArrayList<String> visitProcess4Id2(RuleParser.Process4Id2Context ctx) {
...
/////////////////////////////////////////////////////关联数据处理开始////////////////////////////////////////////
	 ...
	 * attAndTypeName? isList? relationship Style4generate?  '$'     # printAttribute //关联关系*/
	@Override
	...
	*/
	@Override//待处理
	public ArrayList<String> visitProcess4relationship(RuleParser.Process4relationshipContext ctx) {
...
/////////////////////////////////////////////////////数字生成开始////////////////////////////////////////////
	/** attAndTypeName?  limitedInteger Style4generate? '$'    #printInteger */
	@Override 
...
*/
@Override
public ArrayList<String> visitProcess4limitedInteger1(RuleParser.Process4limitedInteger1Context ctx) { 
...
/////////////////////////////////////////////////////可填写取值范围的属性处理开始////////////////////////////////////////////
	/** attAndTypeName?  value4Attribute Style4generate? '$'    #printValue    //可填写取值的属性描述 例如sex（man,woman）*/
	@Override 
	...
	@Override 
	public ArrayList<String> visitProcess4value4Attribute(RuleParser.Process4value4AttributeContext ctx) { 
	...
	@Override 
	public ArrayList<String> visitProcess4values(RuleParser.Process4valuesContext ctx) { 
		String values="";
