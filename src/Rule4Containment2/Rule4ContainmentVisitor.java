...
public interface Rule4ContainmentVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code process4special}
	 * labeled alternative in {@link Rule4ContainmentParser#example4class}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProcess4special(Rule4ContainmentParser.Process4specialContext ctx);
	/**
	 * Visit a parse tree produced by the {@code process4simple}
	 * labeled alternative in {@link Rule4ContainmentParser#example4class}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProcess4simple(Rule4ContainmentParser.Process4simpleContext ctx);
	/**
