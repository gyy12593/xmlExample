...
public class EvalVisitor extends RuleBaseVisitor<String> {
	...
	/** attAndTypeName?  DATE Style4generate? '$'             # printDate   //现在实现的时间是1990年1月1日到现在时间的选取*/
	@Override
...
//		System.out.println("attName="+typeName);
	...
	/**  attAndTypeName?  id Style4generate?   '$'              # printId    */
	@Override
	...
	@Override 
	public String visitPrintValue(RuleParser.PrintValueContext ctx) { 
		String re=visit(ctx.value4Attribute());
		return re;
		//return visitChildren(ctx); 
	}
	/*value4Attribute : attributeName '(' values ')'         #process4value4Attribute*/
	@Override 
	public String visitProcess4value4Attribute(RuleParser.Process4value4AttributeContext ctx) { 
		String[] values=visit(ctx.values()).split(",");
	...
	@Override 
	public String visitProcess4values(RuleParser.Process4valuesContext ctx) { 
		String values="";
